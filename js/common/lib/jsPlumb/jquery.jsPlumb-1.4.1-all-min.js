(function() {
    ...
    jsPlumbUtil = {isArray: function(b) {
        ...
        },segmentMultipliers: [null, [1, -1], [1, 1], [-1, 1], [-1, -1]],inverseSegmentMultipliers: [null, [-1, -1], [-1, 1], [1, 1], [1, -1]],pointOnLine: function(b, f, c) {
...
(function() {
    ...
    window.jsPlumbAdapter = {headless: false,appendToRoot: function(e) {
...
(function() {
    ...
    var A = function(E, F) {
        ...
        this.isDropAllowed = function(af, ac, ad, aa, ab) {
            var ae = R._jsPlumb.checkCondition("beforeDrop", {sourceId: af,targetId: ac,scope: ad,connection: aa,dropEndpoint: ab});
            if (L) {
                try {
        ...
        var G = "__label", Q = function(U) {
            var S = {cssClass: U.cssClass,labelStyle: this.labelStyle,id: G,component: R,_jsPlumb: R._jsPlumb}, T = n.extend(S, U);
    ...
    var u = function(F) {
        ...
        var K = null, aU = null, H = false, Z = null, aH = {}, aC = {}, aE = {}, aa = {}, a2 = {}, aV = {}, aZ = {}, a6 = [], X = [], N = this.Defaults.Scope, R = null, aF = function(a8, a7) {
            ...
            if (!ba.doNotFireConnectionEvent && ba.fireEvent !== false) {
                var a8 = {connection: a9,source: a9.source,target: a9.target,sourceId: a9.sourceId,targetId: a9.targetId,sourceEndpoint: a9.endpoints[0],targetEndpoint: a9.endpoints[1]};
        ...
        var aN = function(ba, bc, a7) {
            var a9 = a0.Defaults.ConnectionType || a0.getDefaultConnectionType(), a8 = ba.constructor == a9, bb = a8 ? {connection: ba,source: ba.source,target: ba.target,sourceId: ba.sourceId,targetId: ba.targetId,sourceEndpoint: ba.endpoints[0],targetEndpoint: ba.endpoints[1]} : ba;
            if (bc) {
        ...
        var M = function(bc, bd) {
            var a7 = {length: bc.length,each: I(bc, bd),get: L(bc)}, bb = ["setHover", "removeAllOverlays", "setLabel", "addClass", "addOverlay", "removeOverlay", "removeOverlays", "showOverlay", "hideOverlay", "showOverlays", "hideOverlays", "setPaintStyle", "setHoverPaintStyle", "setSuspendEvents", "setParameter", "setParameters", "setVisible", "repaint", "addType", "toggleType", "removeType", "removeClass", "setType", "bind", "unbind"], ba = ["getLabel", "getOverlay", "isHover", "getParameter", "getParameters", "getPaintStyle", "getHoverPaintStyle", "isVisible", "hasType", "getType", "isSuspendEvents"];
        ...
        var av = function(a8) {
            var a7 = M(a8, av);
            return n.CurrentLibrary.extend(a7, {setDetachable: af(a8, "setDetachable", av),setReattach: af(a8, "setReattach", av),setConnector: af(a8, "setConnector", av),detach: function() {
                    for (var a9 = 0, ba = a8.length; a9 < ba; a9++) {
                        a0.detach(a8[a9])
                    }
                },isDetachable: aj(a8, "isDetachable"),isReattach: aj(a8, "isReattach")})
        };
        var aR = function(a8) {
            var a7 = M(a8, aR);
            return n.CurrentLibrary.extend(a7, {setEnabled: af(a8, "setEnabled", aR),setAnchor: af(a8, "setAnchor", aR),isEnabled: aj(a8, "isEnabled"),detachAll: function() {
                    for (var a9 = 0, ba = a8.length; a9 < ba; a9++) {
                        a8[a9].detachAll()
                    }
                },remove: function() {
                    ...
                    if (l(bd)) {
                        if (l(bd[0]) || x(bd[0])) {
                            if (bd.length == 2 && x(bd[0]) && t(bd[1])) {
                                ...
                                ba = new n.DynamicAnchor({anchors: bd,selector: null,elementId: a9,jsPlumbInstance: a8})
                            }
                        } else {
                            var bc = {x: bd[0],y: bd[1],orientation: (bd.length >= 4) ? [bd[2], bd[3]] : [0, 0],offsets: (bd.length >= 6) ? [bd[4], bd[5]] : [0, 0],elementId: a9,jsPlumbInstance: a8,cssClass: bd.length == 7 ? bd[6] : null};
                            ba = new n.Anchor(bc);
                            ba.clone = function() {
            ...
            _doOne = function(bn) {
                ...
                var bk = n.extend({}, a8.dropOptions || {}), bj = function() {
                    ...
                    if (bv) {
                        ...
                        var bw = a0.connect({source: bp,target: bB,scope: bA,previousConnection: bx,container: bx.parent,deleteEndpointsOnDetach: bc,endpointsToDeleteOnDetach: bc ? [bp, bB] : null,doNotFireConnectionEvent: bp.endpointWillMoveAfterConnection});
                    ...
                    if (bt.connections.length == 0) {
                        ...
                        if (a9.parent) {
                            ...
                            if (bx) {
                                ...
                                a0.anchorManager.connectionDetached({sourceId: by.sourceId,targetId: by.targetId,connection: by});
                                a5(by)
                            }
                        }
                        bt.repaint();
        ...
        this.setId = function(a9, ba, be) {
            var a7 = a9.constructor == String ? a9 : a0.getId(a9), a8 = a0.getConnections({source: a7,scope: "*"}, true), bc = a0.getConnections({target: a7,scope: "*"}, true);
            ba = "" + ba;
            if (!be) {
        ...
        this.getTestHarness = function() {
            return {endpointsByElement: aC,endpointCount: function(a7) {
                    var a8 = aC[a7];
        ...
        this.adjustForParentOffsetAndScroll = function(bc, a9) {
            ...
            if (ba != null) {
                var a8 = ba.tagName.toLowerCase() === "body" ? {left: 0,top: 0} : r(ba, a0), bb = ba.tagName.toLowerCase() === "body" ? {left: 0,top: 0} : {left: ba.scrollLeft,top: ba.scrollTop};
...
(function() {
    jsPlumb.AnchorManager = function(w) {
        var e = {}, r = {}, u = {}, m = {}, y = {}, v = {HORIZONTAL: "horizontal",VERTICAL: "vertical",DIAGONAL: "diagonal",IDENTITY: "identity"}, g = {}, o = this, h = {}, p = w.jsPlumbInstance, f = jsPlumb.CurrentLibrary, n = {}, k = function(K, L, G, C, H, A) {
            if (K === L) {
            ...
            if (D > C) {
                ...
                return B[0] > A[0] ? 1 : -1
            },right: x(true),bottom: x(true),left: c}, q = function(A, B) {
            return A.sort(B)
        }, i = function(B, A) {
            ...
            if (!p.isSuspendDrawing()) {
                ...
                for (var X = 0; X < ab.length; X++) {
                    if (ab[X].connections.length == 0 && ab[X].anchor.isContinuous) {
                        ...
                        l(h[O], -Math.PI / 2, 0, {endpoints: [ab[X], ab[X]],paint: function() {
        ...
        var t = function(C) {
            ...
            var F = C.faces || ["top", "right", "bottom", "left"], B = !(C.clockwise === false), K = {}, I = {top: "bottom",right: "left",left: "right",bottom: "top"}, E = {top: "right",right: "bottom",left: "top",bottom: "left"}, G = {top: "left",right: "top",left: "bottom",bottom: "right"}, D = B ? E : G, A = B ? G : E, J = C.cssClass || "";
        ...
        p.continuousAnchorFactory = {get: function(B) {
                var A = r[B.elementId];
                if (!A) {
                    A = new t(B);
                    r[B.elementId] = A
    ...
    jsPlumb.AnchorPositionFinders = {Fixed: function(f, c, e, d) {
    ...
    jsPlumb.Anchors.Perimeter = function(c) {
        ...
        var f = {Circle: e,Ellipse: e,Diamond: function() {
...
(function() {
    ...
    jsPlumb.Endpoint = function(h) {
        ...
        this.setEndpoint = function(ab) {
            ...
            var ac = {_jsPlumb: r._jsPlumb,cssClass: h.cssClass,parent: h.parent,container: h.container,tooltip: h.tooltip,connectorTooltip: h.connectorTooltip,endpoint: r};
            if (q.isString(ab)) {
                U = i(ab, ac)
            } else {
                if (q.isArray(ab)) {
        ...
        r.makeInPlaceCopy = function() {
            var ad = r.anchor.getCurrentLocation(r), ac = r.anchor.getOrientation(r), ab = r.anchor.getCssClass(), i = {bind: function() {
                },compute: function() {
                    return [ad[0], ad[1]]
            ...
            return P({anchor: i,source: I,paintStyle: this.getPaintStyle(),endpoint: h.hideOnDrag ? "Blank" : U,_transient: true,scope: r.scope})
        };
            ...
            if ((h.isTarget || ah) && k.isDropSupported(I)) {
                        ...
                        if (!r.isFull() && !(at == 0 && !r.isSource) && !(at == 1 && !r.isTarget) && av) {
                            ...
                            var ak = function() {
                                ...
                                if (!aq.suspendedEndpoint) {
                                    ...
                                    X({source: at == 0 ? aA : aq.source,target: at == 1 ? aA : aq.target,sourceId: at == 0 ? ay : aq.sourceId,targetId: at == 1 ? ay : aq.targetId,sourceEndpoint: at == 0 ? aq.suspendedEndpoint : aq.endpoints[0],targetEndpoint: at == 1 ? aq.suspendedEndpoint : aq.endpoints[1],connection: aq}, true, aj)
                                }
                ...
                ad[ag] = t.wrap(ad[ag], function() {
                    ...
                    if (an != null) {
                        ...
                        if (am) {
                            var al = t.checkCondition("checkDropAllowed", {sourceEndpoint: an.endpoints[aj],targetEndpoint: r,connection: an});
...
(function() {
    jsPlumb.Connection = function(b) {
        ...
        this.getDefaultType = function() {
            return {parameters: {},scope: null,detachable: l._jsPlumb.Defaults.ConnectionsDetachable,rettach: l._jsPlumb.Defaults.ReattachConnections,paintStyle: l._jsPlumb.Defaults.PaintStyle || jsPlumb.Defaults.PaintStyle,connector: l._jsPlumb.Defaults.Connector || jsPlumb.Defaults.Connector,hoverPaintStyle: l._jsPlumb.Defaults.HoverPaintStyle || jsPlumb.Defaults.HoverPaintStyle,overlays: l._jsPlumb.Defaults.ConnectorOverlays || jsPlumb.Defaults.ConnectorOverlays}
        };
        ...
        this.setConnector = function(Q, O) {
            ...
            var R = {_jsPlumb: l._jsPlumb,parent: b.parent,cssClass: b.cssClass,container: b.container,tooltip: l.tooltip,"pointer-events": b["pointer-events"]}, P = o.getRenderMode();
            if (i.isString(Q)) {
                d = B(P, Q, R)
            } else {
                if (i.isArray(Q)) {
        ...
        var x = function(P, O) {
            ...
            if (O) {
                ...
                V = E({paintStyle: Y,hoverPaintStyle: X,endpoint: aa,connections: [l],uuid: Z,anchor: W,source: R,scope: P.scope,container: P.container,reattach: P.reattach || o.Defaults.ReattachConnections,detachable: P.detachable || o.Defaults.ConnectionsDetachable});
                l.endpoints[U] = V;
        ...
        //this.paintStyleInUse = this.getPaintStyle();
        //Fady
        this.paintStyleInUse = b.paintStyle || this.getPaintStyle();
        ...
        if (!o.isSuspendDrawing()) {
            var H = o.getCachedData(this.sourceId), e = H.o, u = H.s, p = o.getCachedData(this.targetId), n = p.o, C = p.s, M = t || o.timestamp(), k = this.endpoints[0].anchor.compute({xy: [e.left, e.top],wh: u,element: this.endpoints[0],elementId: this.endpoints[0].elementId,txy: [n.left, n.top],twh: C,tElement: this.endpoints[1],timestamp: M});
            this.endpoints[0].paint({anchorLoc: k,timestamp: M});
            k = this.endpoints[1].anchor.compute({xy: [n.left, n.top],wh: C,element: this.endpoints[1],elementId: this.endpoints[1].elementId,txy: [e.left, e.top],twh: u,tElement: this.endpoints[0],timestamp: M});
        ...
        this.paint = function(ag) {
            if (r) {
                ...
                if (Q == null || Q != v) {
                    var aj = o.updateOffset({elId: X,offset: Y,recalc: U,timestamp: Q}).o, V = o.updateOffset({elId: af,timestamp: Q}).o, ab = this.endpoints[ai], P = this.endpoints[R];
                    if (ag.clearEdits) {
                    ...
                    d.resetBounds();
                    d.compute({sourcePos: S,targetPos: ae,sourceEndpoint: this.endpoints[ai],targetEndpoint: this.endpoints[R],lineWidth: l.paintStyleInUse.lineWidth,sourceInfo: aj,targetInfo: V,clearEdits: ag.clearEdits === true});
                    ...
                    var O = parseFloat(l.paintStyleInUse.lineWidth || 1) / 2, ah = parseFloat(l.paintStyleInUse.lineWidth || 0), ac = {xmin: Math.min(d.bounds.minX - (O + ah), W.minX),ymin: Math.min(d.bounds.minY - (O + ah), W.minY),xmax: Math.max(d.bounds.maxX + (O + ah), W.maxX),ymax: Math.max(d.bounds.maxY + (O + ah), W.maxY)};
...
(function() {
    ...
    jsPlumb.Segments = {AbstractSegment: function(e) {
            this.params = e;
            ...
            this.pointAlongPathFrom = function(m, u, t) {
                var s = q.pointOnPath(m, t), r = m == 1 ? {x: g + ((f - g) * 10),y: n + ((n - l) * 10)} : u <= 0 ? {x: g,y: n} : {x: f,y: l};
                if (u <= 0 && Math.abs(u) > 1) {
                    u *= -1
                }
            ...
            var e = this, g = jsPlumb.Segments.AbstractSegment.apply(this, arguments), i = [{x: k.x1,y: k.y1}, {x: k.cp1x,y: k.cp1y}, {x: k.cp2x,y: k.cp2y}, {x: k.x2,y: k.y2}], f = {minX: Math.min(k.x1, k.x2, k.cp1x, k.cp2x),minY: Math.min(k.y1, k.y2, k.cp1y, k.cp2y),maxX: Math.max(k.x1, k.x2, k.cp1x, k.cp2x),maxY: Math.max(k.y1, k.y2, k.cp1y, k.cp2y)};
            this.type = "Bezier";
    ...
    jsPlumb.Connectors.AbstractConnector = function(z) {
        ...
        return {addSegment: w,prepareCompute: q,sourceStub: l,targetStub: r,maxStub: Math.max(l, r),sourceGap: m,targetGap: o,maxGap: Math.max(m, o)}
    };
    ...
    jsPlumb.Overlays.Arrow = function(k) {
        ...
        this.draw = function(v, z) {
            ...
            if (v.pointAlongPathFrom) {
                ...
                var t = {hxy: r,tail: s,cxy: q}, u = h.strokeStyle || z.strokeStyle, x = h.fillStyle || z.strokeStyle, p = h.lineWidth || z.lineWidth, m = {component: v,d: t,lineWidth: p,strokeStyle: u,fillStyle: x,minX: Math.min(r.x, s[0].x, s[1].x),maxX: Math.max(r.x, s[0].x, s[1].x),minY: Math.min(r.y, s[0].y, s[1].y),maxY: Math.max(r.y, s[0].y, s[1].y)};
                return m
            } else {
    ...
    var a = function(f) {
        ...
        this.draw = function(r, w) {
            ...
            if (o != null && o.length == 2) {
                ...
                return {component: r,d: {minx: v,miny: t,td: o,cxy: p},minX: v,maxX: v + o[0],minY: t,maxY: t + o[1]}
            } else {
    ...
    jsPlumb.Overlays.GuideLines = function() {
        ...
        this.draw = function(g, m) {
            ...
            return {connector: g,head: l,tail: i,headLine: f,tailLine: h,minX: Math.min(l.x, i.x, f[0].x, f[1].x),minY: Math.min(l.y, i.y, f[0].y, f[1].y),maxX: Math.max(l.x, i.x, f[0].x, f[1].x),maxY: Math.max(l.y, i.y, f[0].y, f[1].y)}
        };
        this.cleanup = function() {
        }
    };
    ...
    jsPlumb.Connectors.StateMachine = function(g) {
        ...
        this._compute = function(v, O) {
            ...
            if (!l || (O.sourceEndpoint.elementId !== O.targetEndpoint.elementId)) {
                ...
                v.points[2] = G;
                v.points[3] = M;
                k.addSegment("Arc", {x1: (N - E) + 4,y1: t - C,startAngle: 0,endAngle: 2 * Math.PI,r: f,ac: !e,x2: (N - E) - 4,y2: t - C,cx: s - E,cy: p - C})
            }
        }
    }
})();
...
(function() {
    ...
    var t = 1000, s = {}, a = function(u, i) {
        ...
        this.paint = function(y) {
            if (y !== null) {
                ...
                if (y.outlineColor) {
                    var E = y.outlineWidth || 1, F = y.lineWidth + (2 * E), D = {strokeStyle: jsPlumbUtil.convertStyle(y.outlineColor),lineWidth: F};
                    for (var x in h) {
                        D[x] = y[x]
                    }
                    if (i.bgCanvas == null) {
    ...
    jsPlumb.Segments.vml = {SegmentRenderer: {getPath: function(i) {
                return ({Straight: function(u) {
                        var v = u.params;
...
(function() {
    var l = {joinstyle: "stroke-linejoin","stroke-linejoin": "stroke-linejoin","stroke-dashoffset": "stroke-dashoffset","stroke-linecap": "stroke-linecap"}, w = "stroke-dasharray", B = "dashstyle", e = "linearGradient", b = "radialGradient", c = "fill", a = "stop", A = "stroke", q = "stroke-width", h = "style", m = "none", t = "jsplumb_gradient_", o = "lineWidth", D = {svg: "http://www.w3.org/2000/svg",xhtml: "http://www.w3.org/1999/xhtml"}, g = function(G, E) {
        for (var F in E) {
        ...
        for (var L = 0; L < G.gradient.stops.length; L++) {
            var I = K.segment == 1 || K.segment == 2 ? L : G.gradient.stops.length - 1 - L, N = jsPlumbUtil.convertStyle(G.gradient.stops[I][1], true), P = f(a, {offset: Math.floor(G.gradient.stops[L][0] * 100) + "%","stop-color": N});
            M.appendChild(P)
        }
    ...
    var s = function(J) {
        ...
        var G = J.cssClass + " " + (J.originalArgs[0].cssClass || ""), K = {style: "",width: 0,height: 0,"pointer-events": H,position: "absolute"};
        E.svg = f("svg", K);
        if (J.useDivWrapper) {
            E.canvas = document.createElement("div");
            E.canvas.style.position = "absolute";
    ...
    var d = jsPlumb.ConnectorRenderers.svg = function(G) {
        var E = this, F = s.apply(this, [{cssClass: G._jsPlumb.connectorClass,originalArgs: arguments,pointerEventsSpec: "none",_jsPlumb: G._jsPlumb}]);
        F.renderer.paint = function(H, L, Q) {
            ...
            var R = {d: I,transform: "translate(" + J[0] + "," + J[1] + ")","pointer-events": G["pointer-events"] || "visibleStroke"}, O = null, N = [E.x, E.y, E.w, E.h];
            if (H.outlineColor) {
    ...
    jsPlumb.Segments.svg = {SegmentRenderer: {getPath: function(E) {
    ...
    var y = window.SvgEndpoint = function(G) {
        var E = this, F = s.apply(this, [{cssClass: G._jsPlumb.endpointClass,originalArgs: arguments,pointerEventsSpec: "all",useDivWrapper: true,_jsPlumb: G._jsPlumb}]);
    ...
    var p = function(I, G) {
        ...
        this.paint = function(M, J) {
            if (M.component.svg && J) {
                ...
                g(H, {d: F(M.d),"class": K,stroke: M.strokeStyle ? M.strokeStyle : null,fill: M.fillStyle ? M.fillStyle : null,transform: "translate(" + L[0] + "," + L[1] + ")"})
            }
        };
        var F = function(J) {
    ...
    jsPlumb.Overlays.svg.GuideLines = function() {
        ...
        this.paint = function(L, J) {
            ...
            g(H, {d: F(L.tailLine[0], L.tailLine[1]),stroke: "blue",fill: null,transform: "translate(" + K[0] + "," + K[1] + ")"});
            g(G, {d: F(L.headLine[0], L.headLine[1]),stroke: "green",fill: null,transform: "translate(" + K[0] + "," + K[1] + ")"})
        };
        var F = function(K, J) {
...
(function(b) {
    ...
    jsPlumb.CurrentLibrary = {addClass: function(d, c) {
            d = a(d);
            try {
            ...
            c = a(c);
            c.bind(d, e)
        },dragEvents: {start: "start",stop: "stop",drag: "drag",step: "step",over: "over",out: "out",drop: "drop",complete: "complete"},extend: function(d, c) {
            return b.extend(d, c)
        ...
        },getElementObject: a,getOffset: function(c) {
            return c.offset()
...
(function() {
    ...
    window.jsBezier = {distanceFromCurve: f,gradientAtPoint: g,gradientAtPointAlongCurveFrom: function(n, m, o) {
            m = k(n, m, o);
