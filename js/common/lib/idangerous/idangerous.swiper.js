...
var Swiper = function(a, b) {
    ...
    function p(a) {
        ...
        if( target.prop("tagName") == "circle"
            || target.prop("tagName") == "path"
            || target.prop("tagName") == "TEXTAREA"                                         
            || target.hasClass("flashCrd").toString() == "true"
            || target.hasClass("carousel").toString() == "true" 
            || target.hasClass("draggable-element").toString() == "true" 
            || target.hasClass("galleryText").toString() == "true" 
            || target.hasClass("gameWrapper").toString() == "true" 
            || target.hasClass("leftImages").toString() == "true" 
            || target.hasClass("fullItem").toString() == "true"
            || target.hasClass("dndDragContainer").toString() == "true"
            //|| target.hasClass("swiper-slide").toString() == "true"
            || target.parents("div .galleryText").length > 0
            || target.parents("div .gameWrapper").length > 0
            || target.parents("div .draggable-element").length > 0
            || target.parents("div .flashcard-content").length > 0
            //|| target.parents("div .swiper-slide").length > 0
            || target.parents("div .fullItem").length > 0
            || target.parents("div .swipe").length > 0
            || target.parents("div .dndDragContainer").length > 0
            || target.prop("tagName") == "INPUT" 
            || target.hasClass("highlightContainer").toString() == "true"
            || target.parents("div .highlightContainer").length > 0
            ){            
                return !1;
            }
        /*DFI End*/
        ...
        if(target.parents(".slidingElements").length > 0){
    ...
    if (window.getComputedStyle || (window.getComputedStyle = function(a) {
        ...
        }, C.previousSlide = function() { /*DFI*/
            return C.slides[C.previousIndex]
