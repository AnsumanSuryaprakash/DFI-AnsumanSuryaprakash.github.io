...
var Swiper = function(f, b) {
    ...
    function s(c) {
        ...
        if( target.prop("tagName") == "circle"
            ...
            || target.hasClass("desc").toString() == "true" 
            ...
            || target.hasClass("touchpanview-wrap").toString() == "true"
            ...
            || target.parents("div .touchpanview-wrap").length > 0
            //|| target.parents("div .swiper-slide").length > 0
            || target.parents("div .fullItem").length > 0
            || target.parents("div .swipe").length > 0
            || target.hasClass("questdraggbale").toString() == "true" 
            || target.parent().hasClass("questdraggbale").toString() == "true"
            || target.hasClass("questSelect").toString() == "true"
    ...
    if (f.nodeType || document.querySelectorAll && 0 != document.querySelectorAll(f).length) {
        ...
        a.wrapper = n;
        h = "horizontal" == b.mode;
        a.touchEvents = {touchStart: a.support.touch || !b.simulateTouch ? "touchstart" : a.ie10 ? "MSPointerDown" : "mousedown",touchMove: a.support.touch || !b.simulateTouch ? "touchmove" : a.ie10 ? "MSPointerMove" : "mousemove",touchEnd: a.support.touch || !b.simulateTouch ? "touchend" : a.ie10 ? "MSPointerUp" : "mouseup"};
        ...
        a.ie10 ? (n.addEventListener(a.touchEvents.touchStart, s, !1), n.addEventListener(a.touchEvents.touchMove, v, !1), n.addEventListener(a.touchEvents.touchEnd, r, !1)) : (a.support.touch && (n.addEventListener("touchstart", s, !1), n.addEventListener("touchmove", v, !1), n.addEventListener("touchend", r, !1)), b.simulateTouch && (n.addEventListener("mousedown", s, !1), n.addEventListener("mousemove", v, !1), n.addEventListener("mouseup", r, !1)));
...
Swiper.prototype = {plugins: {},transitionEnd: function(f, b) {
        ...
        this.callPlugins("onSetTransform", {x: f,y: b,z: g})
        ...
        this.callPlugins("onSetTransition", {duration: f})
    },ie8: function() {
        var f = -1;
